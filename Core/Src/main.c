...
int main(void)
{
  ...
  uint8_t test[] = {0x5b,0x76,0x31,0x5d,0x5b,0x6d,0x30,0x5d,0x5b,0x74,0x35,0x5d,0x73,0x74,0x6d,0x33,0x32,0xaf,0x75,0xaa,0xba,0xa4,0xa3,0xba,0xe2,0xa6,0x6e,0xa5,0xce};
	/* USER CODE END 1 */
